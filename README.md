...
The whole demo lives in `agent.R`, you only need to have a valid `ANTHROPIC_API_KEY` environment variable and then run `agent.R` interactively in R. It turns out you only need ~80 lines of code and
